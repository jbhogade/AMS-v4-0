@echo off
REM ===========================================================================
REM  Setup-AMS-v4-0.bat  -  creates the AMS-v4-0 database + schema
REM ---------------------------------------------------------------------------
...
echo.
echo  ==========================================================
echo   AMS-v4-0 Database Setup
echo  ==========================================================
echo.

set "DBNAME=AMS-v4-0"
set "SQLFILE=%~dp0AMS-v4-0.sql"
...
if errorlevel 1 (
    ...
    echo      the AMS-v4-0 database manually in SSMS.
    echo.
    pause
    exit /b 1
)
...
echo        (default: Server=.\SQLEXPRESS;Database=AMS-v4-0;
